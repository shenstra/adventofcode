...
namespace Advent.AoC2020
{
    class Day9
    {
        ...
        private List<long> FindSequenceWithSum(List<long> numbers, long invalidNumber)
        {
        ...
        private long FindInvalidNumber(List<long> numbers, int preambleSize)
        {
        ...
        private bool CanSumFrom(List<long> numbers, long target)
        {
